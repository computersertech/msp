...
<ul>
  ...
  <li>Microsoft Azure Installation, Migration, Security, Administration, and Implementation</li>
  <li>Amazon Web Services (AWS) Installation, Migration, Security, Administration, and Implementation</li>
  <li>Google Cloud Platform (GCP) Installation, Migration, Security, Administration, and Implementation</li>
